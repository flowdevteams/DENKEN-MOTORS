    ...
    <div className="pt-24 pb-24 min-h-screen bg-secondary/30">
      <div className="mx-auto max-w-3xl px-5 lg:px-8">
        ...
        >
          ...
          {step === 3 && (
            <div className="space-y-6">
              <h2 className="font-display text-2xl font-bold mb-6">3. Rencana Pembiayaan</h2>
              <div>
                <label className="text-sm font-bold mb-2 block">Rencana Uang Muka (DP)</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full rounded-xl border border-border bg-muted/50 p-4 pl-12 font-mono font-bold outline-none focus:border-primary"
                    placeholder="100.000.000"
                  />
                </div>
              </div>
              <div>
                <label className="text-sm font-bold mb-2 block">Pilih Tenor Kredit</label>
          ...
          {step === 4 && (
            <div className="space-y-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="font-display text-2xl font-bold">4. Ringkasan Pengajuan</h2>
              </div>
